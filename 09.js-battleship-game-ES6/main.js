let game = new Game(),
    FirstPlayerOfType = createPlayer('Student'),
    firstPlayer = new FirstPlayerOfType('Ivan', 'Petrov'),

    SecondPlayerOfType = createPlayer('Worker'),
    secondPlayer = new SecondPlayerOfType('Hristo', 'Todorov'),
    attackPosition;
